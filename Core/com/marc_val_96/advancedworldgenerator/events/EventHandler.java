package com.marc_val_96.advancedworldgenerator.events;
 ...
 * AWG.registerEventHander(..). If you want to use the onStart(),
 * make sure that it is registered before AWG is started.
 */
