...
public class BiomeModeManager {
    ...
    public Class<? extends BiomeGenerator> getBiomeManager(String name) {
        ...
        AWG.log(LogMarker.WARN, "{} is not a valid biome mode, falling back on Normal.", name);
        return NORMAL;
    }
    ...
    public <T extends BiomeGenerator> BiomeGenerator create(Class<T> clazz, LocalWorld world) {
        try {
            ...
            AWG.log(LogMarker.FATAL, "Cannot properly reflect biome manager, falling back on BiomeMode:Normal");
