...
public class MesaSurfaceGenerator implements SurfaceGenerator {
    ...
    public MesaSurfaceGenerator(boolean mountainMesa, boolean forestMesa) {
        ...
        this.hardenedClay = AWG.toLocalMaterialData(DefaultMaterial.HARD_CLAY, 0);
        this.redSand = AWG.toLocalMaterialData(DefaultMaterial.SAND, 1);
        this.coarseDirt = AWG.toLocalMaterialData(DefaultMaterial.DIRT, 1);
        this.whiteStainedClay = AWG.toLocalMaterialData(DefaultMaterial.STAINED_CLAY, 0);
        this.orangeStainedClay = AWG.toLocalMaterialData(DefaultMaterial.STAINED_CLAY, 1);
        this.yellowStainedClay = AWG.toLocalMaterialData(DefaultMaterial.STAINED_CLAY, 4);
        this.brownStainedClay = AWG.toLocalMaterialData(DefaultMaterial.STAINED_CLAY, 12);
        this.redStainedClay = AWG.toLocalMaterialData(DefaultMaterial.STAINED_CLAY, 14);
        this.silverStainedClay = AWG.toLocalMaterialData(DefaultMaterial.STAINED_CLAY, 8);
    }
