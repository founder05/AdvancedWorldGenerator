package com.marc_val_96.advancedworldgenerator.exception;
...
public class BiomeNotFoundException extends RuntimeException {
     ...
     *
     * @param biomeName The biome name that was not found.
     * @param biomes    All biomes in the list. {@link Object#toString()} is used to
     *                  print the biomes.
     */
