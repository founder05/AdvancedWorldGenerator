...
import com.marc_val_96.advancedworldgenerator.configuration.ErroredFunction;
import com.marc_val_96.advancedworldgenerator.configuration.io.RawSettingValue.ValueType;
...
import com.marc_val_96.advancedworldgenerator.util.helpers.InheritanceHelper;
...
public final class SimpleSettingsMap implements SettingsMap {
    ...
    public <T> List<ConfigFunction<T>> getConfigFunctions(T holder, boolean useFallback) {
        ...
        ConfigFunctionsManager manager = AWG.getConfigFunctionsManager();
        for (RawSettingValue configFunctionLine : configFunctions) {
            ...
            if (function instanceof ErroredFunction) {
                AWG.log(LogMarker.WARN, "Invalid resource {} in {} on line {}: {}",
    ...
    public <S> S getSetting(Setting<S> setting, S defaultValue) {
        ...
        if (stringWithLineNumber != null) {
            ...
            try {
                ...
                AWG.log(LogMarker.ERROR, "The value \"{}\" is not valid for the setting {} in {} on line {}: {}",
