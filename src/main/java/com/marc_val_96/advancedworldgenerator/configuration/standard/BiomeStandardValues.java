...
import com.marc_val_96.advancedworldgenerator.configuration.settingType.DoubleArraySetting;
...
public class BiomeStandardValues extends Settings
{
    ...
    public static final Setting<LocalMaterialData>
        ...
        SURFACE_BLOCK = new MaterialSetting("SurfaceBlock", DefaultMaterial.GRASS_BLOCK),
