...
import com.marc_val_96.advancedworldgenerator.customobjects.bo2.BO2Loader;
import com.marc_val_96.advancedworldgenerator.customobjects.bo3.BO3Loader;
...
public class CustomObjectManager {
    ...
    public void loadGlobalObjects() {
        ...
        this.globalCustomObjects.load(this.loaders, AWG.getEngine().getGlobalObjectsDirectory());
        AWG.log(LogMarker.INFO, "{} Global custom objects loaded", globalCustomObjects.getAll().size());
    }
