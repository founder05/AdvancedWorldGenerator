...
import static com.marc_val_96.advancedworldgenerator.util.ChunkCoordinate.CHUNK_Y_SIZE;
...
public class SimpleSurfaceGenerator implements SurfaceGenerator {
    ...
    private final LocalMaterialData sandstone = AWG.toLocalMaterialData(DefaultMaterial.SANDSTONE, 0);
